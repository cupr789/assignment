        ...
        <div class="my-auto">
          <h1 class="mb-0">LOGIN		
            <span class="text-primary"></span>
				...
				<a href="/view/user/signin" style="margin: 1em"><input class="btn btn-lg btn-primary btn-block" type="button"
					id="loginBtn" value="Sign In" onclick="checkValue()" style="background-color: white; color: black; border-color: black;" ></a>
			</form>
